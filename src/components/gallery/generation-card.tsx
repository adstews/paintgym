          ...
          <div style={{ position: "relative" }}>
            ...
            >
              <div className="pg-ad" style={{ background: "var(--paper)" }}>
                {/* Show the rendered image as soon as it exists — even while QA
                    is still reviewing/rewriting. The QA state is conveyed by the
                    small corner badge below, not by hiding the whole image. Only
                    show a full-cover spinner when there is genuinely no image
                    yet (still rendering, or lazy-load in flight). */}
                {displayUrl ? (
                  <Image
                    src={displayUrl}
                    alt={conceptName}
